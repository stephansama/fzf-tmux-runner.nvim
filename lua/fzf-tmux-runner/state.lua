...
---Saves the state in the global _G.FzfTmuxRunner.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.FzfTmuxRunner.state")

    _G.FzfTmuxRunner.state = self
end
...
---Whether the FzfTmuxRunner is enabled or not.
---
